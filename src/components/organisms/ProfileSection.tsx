    ...
    return (
        <div className="relative flex flex-col bg-[#F9F8F6] rounded-2xl h-full border">
            <section className="w-full z-0 md:h-auto">
                <img src={profile} className="rounded-2xl object-cover" alt="avatar" />
                <div className="absolute top-[-1px] left-[-1px] z-50">
                    <SocialIcons />
                </div>
            </section>
            <section className="w-full bg-white space-y-2 z-50 bayangan p-5 border border-gray-200 rounded-2xl h-full xl:h-auto xl:absolute xl:bottom-0">
