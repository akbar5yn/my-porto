...
const stackData: interfaceStackData[] = [
    {
        iconCard: <PiGearSixBold className="w-12 h-12 items-center flex justify-center" />,
        cardTitle: "Agile",
    ...
    {
        iconCard: <TbBrandTailwind className="w-12 h-12 items-center flex justify-center" />,
    ...
    {
        iconCard: <FaVuejs className="w-12 h-12 items-center flex justify-center" />,
        cardTitle: "Vue.js",
    ...
    {
        iconCard: <TbBrandLaravel className="w-12 h-12 items-center flex justify-center" />,
        cardTitle: "Laravel",
    ...
    {
        iconCard: <RiNodejsLine className="w-12 h-12 items-center flex justify-center" />,
    ...
    {
        iconCard: <SiMysql className="w-12 h-12 items-center flex justify-center" />,
        cardTitle: "MySQL",
    ...
    {
        iconCard: <SiMongodb className="w-12 h-12 items-center flex justify-center" />,
        cardTitle: "MongoDB",
    ...
    {
        iconCard: <BiLogoPostgresql className="w-12 h-12 items-center flex justify-center" />,
    ...
    {
        iconCard: <SiRefinedgithub className="w-12 h-12 items-center flex justify-center" />,
        cardTitle: "GitHub",
    ...
    {
        iconCard: <LiaDocker className="w-12 h-12 items-center flex justify-center" />,
        cardTitle: "Docker",
    ...
    {
        iconCard: <SiClevercloud className="w-12 h-12 items-center flex justify-center" />,
        cardTitle: "Vercel",
    ...
    {
        iconCard: <SiNetlify className="w-12 h-12 items-center flex justify-center" />,
        cardTitle: "Netlify",
